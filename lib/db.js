...
module.exports = function (
  ...
  DB.prototype.webSessions = function (uid) {
    log.trace({ op: 'DB.webSessions', uid: uid })

    return this.pool.get('/account/' + uid.toString('hex') + '/web-sessions')
      .then(
        function (body) {
          return body.map(function (item) {
            return bufferize({
              ...
              ignore: ['lastAccessTime', 'uaBrowser', 'uaBrowserVersion']
            })
          })
        },
        function (err) {
